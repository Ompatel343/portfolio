...
import CertificateIcon from "@/assets/images/aws.png"; // Optional: Add AWS logo if you want
          ...
          <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            ...
            <div className="relative space-y-4">
              <p className="text-white">
                Hey there! I'm Om Patel - a React.js-focused full-stack
              ...
              <div className="pt-6">
                <blockquote className="border-l-4 border-gray-300 pl-4">
                  <p className="text-white">
                    I’ve solved 350+ DSA problems, earned my AWS Cloud
                    Practitioner certification, and actively contribute to open
                    source. I’m a creative thinker who enjoys working on
                    high-impact projects and continuously learning new
                    technologies.
                  </p>

                  <div className="mt-6 space-y-3">
                    <cite className="block font-medium text-white">
                      Om Patel, AWS Certified & MERN Developer
                    </cite>
                    <div className="flex items-center gap-2">
                      <img
                        className="h-5 w-auto"
                        src={CertificateIcon}
                        alt="AWS Certificate Logo"
                        height="20"
                        width="auto"
                      />
